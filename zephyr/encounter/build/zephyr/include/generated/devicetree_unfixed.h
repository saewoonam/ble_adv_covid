 ...
 *   65  /soc/qspi@40029000/mx25r6435f@0/partitions
 *   66  /soc/qspi@40029000/mx25r6435f@0/partitions/partition@0
 *
 ...
 *
 * Node's generated path identifier: DT_N_S_soc_S_qspi_40029000_S_mx25r6435f_0_S_partitions
 *
 ...
 *
 * Node's generated path identifier: DT_N_S_soc_S_qspi_40029000_S_mx25r6435f_0_S_partitions_S_partition_0
 *
...
#define DT_N_INST_fixed_partitions_NUM 2
...
#define DT_N_INST_nordic_nrf_rng_NUM 1
...
#define DT_FOREACH_INST_nordic_nrf52840_dk_nrf52840(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf52840_qiaa(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf52840(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf52(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_simple_bus(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_arm_v7m_nvic(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf52_flash_controller(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_soc_nv_flash(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_fixed_partitions(fn) DT_FOREACH_IMPL_2(fn)
#define DT_FOREACH_INST_mmio_sram(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_saadc(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_clock(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_uart(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_uarte(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_gpiote(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_gpio(fn) DT_FOREACH_IMPL_2(fn)
#define DT_FOREACH_INST_nordic_nrf_twi(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_pwm(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_rng(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_spi(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_spim(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_qspi(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_qspi_nor(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_rtc(fn) DT_FOREACH_IMPL_3(fn)
#define DT_FOREACH_INST_nordic_nrf_timer(fn) DT_FOREACH_IMPL_5(fn)
#define DT_FOREACH_INST_nordic_nrf_temp(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_usbd(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_watchdog(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_nordic_nrf_cc310(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_arm_cryptocell_310(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_arm_cortex_m4f(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_gpio_leds(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_pwm_leds(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_gpio_keys(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_arduino_header_r3(fn) DT_FOREACH_IMPL_1(fn)
#define DT_FOREACH_INST_arduino_uno_adc(fn) DT_FOREACH_IMPL_1(fn)

/*
 * Bus information for enabled nodes of each compatible
 */
#define DT_COMPAT_fixed_partitions_BUS_qspi 1
